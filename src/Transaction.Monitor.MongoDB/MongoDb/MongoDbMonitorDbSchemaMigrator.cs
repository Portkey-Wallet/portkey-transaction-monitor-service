...
using Transaction.Monitor.Data;
using Volo.Abp.Data;
...
public class MongoDbMonitorDbSchemaMigrator : IMonitorDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbMonitorDbSchemaMigrator(IServiceProvider serviceProvider)
    {
