...
// using Volo.Abp.Uow;
//
// namespace Transaction.Monitor.OpenIddict;
//
...
//     {
//         if (await _openIddictScopeRepository.FindByNameAsync("Monitor") == null)
//         {
//             await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
//                 Name = "Monitor", DisplayName = "Monitor API", Resources = { "Monitor" }
//             });
//         }
//     }
//
...
//         var consoleAndAngularClientId = configurationSection["Monitor_App:ClientId"];
//         if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
//         {
//             var consoleAndAngularClientRootUrl = configurationSection["Monitor_App:RootUrl"]?.TrimEnd('/');
...
//
//         // Swagger Client
//         var swaggerClientId = configurationSection["Monitor_Swagger:ClientId"];
//         if (!swaggerClientId.IsNullOrWhiteSpace())
//         {
//             var swaggerRootUrl = configurationSection["Monitor_Swagger:RootUrl"]?.TrimEnd('/');
//
//             await CreateApplicationAsync(
